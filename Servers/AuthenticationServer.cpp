...
AuthenticationServer::AuthenticationServer(string gatewayServerIP, int gatewayServerPort, int maxConnections, int numChannels,
...
void AuthenticationServer::shutdown() {
